	...
	useEffect(() => {
		if (open && resultId) {
			...
			getResultWithAnswers(resultId).then((response) => {
				console.log('[ResultDetailsModal] Response:', response)
				if (response.success) {
							...
							<div className="space-y-6">
								...
								<div className="space-y-3">
									<div className="flex items-center justify-between">
										...
										<div
											className={`px-4 py-2 rounded-lg text-2xl font-bold ${data.result.score >= 70
													...
													<div className="flex items-start gap-3">
														...
														<div className="flex-1 space-y-2">
															...
															<div className="space-y-1">
																...
																<div
																	className={`p-2 rounded border ${answer.is_correct
