				...
				<div className="flex items-start justify-between gap-2">
					<div className="flex-1">
						<div className="flex items-center gap-2 mb-2">
							<span className={`px-2 py-1 text-xs rounded-full font-medium ${module.type === 'exam'
							...
							{module.type === 'exam' && (
								<span className={`px-2 py-1 text-xs rounded-full font-medium ${module.is_unlocked
				...
				{hasResult ? (
					<div className="space-y-6 flex flex-col flex-1">
						...
						<div className="rounded-xl bg-muted border border-border p-5 space-y-3">
							...
							<div className="flex items-baseline gap-2">
								<span className={`text-4xl font-bold ${result.score >= 70 ? 'text-emerald-400' : 'text-red-400'
									}`}>
					...
					<div className="flex flex-col flex-1">
						...
						{module.type === 'exam' && !module.is_unlocked ? (
							<Button
								className="w-full gap-2 bg-emerald-600 hover:bg-emerald-700 mt-auto"
								disabled
								title="This exam is locked. Please contact an administrator to unlock it."
							>
