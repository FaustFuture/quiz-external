									...
									<div className="flex overflow-hidden rounded-md border border-gray-200/10">
										...
										<DropdownMenu onOpenChange={(open) => { if (open) setTimeRange("day") }}>
											<DropdownMenuTrigger asChild>
												<button
													type="button"
													className={`px-3 h-9 text-sm ${timeRange === "day" ? "bg-emerald-600 text-white" : "bg-muted text-foreground"
										...
										<DropdownMenu onOpenChange={(open) => { if (open) setTimeRange("week") }}>
											<DropdownMenuTrigger asChild>
												<button
													type="button"
													className={`px-3 h-9 text-sm ${timeRange === "week" ? "bg-emerald-600 text-white" : "bg-muted text-foreground"
														} border-r border-gray-200/10`}
										...
										<DropdownMenu onOpenChange={(open) => { if (open) setTimeRange("month") }}>
											<DropdownMenuTrigger asChild>
												<button
													type="button"
													className={`px-3 h-9 text-sm ${timeRange === "month" ? "bg-emerald-600 text-white" : "bg-muted text-foreground"
														} border-r border-gray-200/10`}
										...
										<button
											...
											className={`px-3 h-9 text-sm ${timeRange === "all" ? "bg-emerald-600 text-white" : "bg-muted text-foreground"
												}`}
										...
										<div className="flex items-center justify-between gap-3">
											...
											<div className="flex-1 min-w-0">
												<div className="flex items-center gap-2 mb-1">
													...
													<span
														className={`px-1.5 py-0.5 rounded text-xs font-semibold ${result.score >= 70
													...
													<span
														className={`px-1.5 py-0.5 rounded text-[10px] font-semibold ${moduleIdToType[result.module_id] === 'exam'
